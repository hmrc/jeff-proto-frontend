...
object IndividualAccountSubmission {
  implicit def formats: OFormat[IndividualAccountSubmission] = Json.format[IndividualAccountSubmission]
}
...
object IndividualAccount {
  implicit def formats: OFormat[IndividualAccount] = Json.format[IndividualAccount]
}

object DetailedIndividualAccount {
  implicit def formats: OFormat[DetailedIndividualAccount] = Json.format[DetailedIndividualAccount]
}
