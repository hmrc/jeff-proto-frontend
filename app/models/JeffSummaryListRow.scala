...
final case class JeffSummaryListRow(
...
object JeffSummaryListRow {
  def summarise(checkYourAnswerRow: JeffSummaryListRow)(implicit messages: Messages): SummaryListRow = {
